...
const NetworkStatus: React.FC<NetworkStatusProps> = ({ health, loading = false }) => {
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-sm font-medium text-gray-900 dark:text-white">{health.peer_count}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600 dark:text-gray-400">Sync Status</span>
            <span className={`text-sm font-medium capitalize ${getStatusColor(health.sync_status)}`}>
              {health.sync_status}
            </span>
          </div>
          <div className="flex justify-between items-center">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className={`flex items-center space-x-2 ${isConnected ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
