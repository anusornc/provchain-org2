...
export const blockchainAPI = {
  ...
  getBlockRdfSummary: (index: number) =>
    api.get(`/blockchain/blocks/${index}/rdf-summary`),
...
export const productAPI = {
  getTrace: (productId: string) =>
    api.get("/products/trace", { params: { productId } }),
  getEnhancedTrace: (productId: string) =>
    api.get("/products/trace/enhanced", { params: { productId } }),
};
