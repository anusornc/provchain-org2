...
const RDFTripleStore: React.FC = () => {
  ...
  const [newTriple, setNewTriple] = useState({
    subject: "",
    predicate: "",
    object: "",
  });
  ...
  const loadRealData = async () => {
    try {
      ...
      const loadedTriples: RDFTriple[] = (
        response.data as SPARQLResponse
      ...
      const sampleTriples: RDFTriple[] = [
        {
          subject: "http://provchain.org/core#Product",
          predicate: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
          object: "http://www.w3.org/2002/07/owl#Class",
        },
        {
          subject: "http://provchain.org/core#Process",
          predicate: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
          object: "http://www.w3.org/2002/07/owl#Class",
        },
        {
          subject: "http://provchain.org/core#Supplier",
          predicate: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
          object: "http://www.w3.org/2002/07/owl#Class",
        },
        {
          subject: "http://provchain.org/core#derivedFrom",
          predicate: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
          object: "http://www.w3.org/2002/07/owl#ObjectProperty",
        },
        {
          subject: "http://provchain.org/core#Certificate",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 text-center">
              ...
              <div className="text-xl font-bold text-purple-600 dark:text-purple-400">
                {new Set(triples.map((t) => t.subject)).size}
              </div>
              <div className="text-xs text-gray-600 dark:text-gray-300">
                Unique Subjects
              </div>
                ...
                <tr key={index} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Badge variant="primary" title={triple.subject}>
                      {triple.subject.length > 50
                        ? triple.subject.substring(0, 50) + "..."
                        : triple.subject}
                    </Badge>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Badge variant="secondary" title={triple.predicate}>
                      {triple.predicate.length > 40
                        ? triple.predicate.substring(0, 40) + "..."
                        : triple.predicate}
                    </Badge>
                  </td>
                  <td
                    ...
                    title={triple.object}
                  >
                    {triple.object.length > 60
                      ? triple.object.substring(0, 60) + "..."
                      : triple.object}
                  </td>
                </tr>
              ))}
