...
pub fn bench_entities_to_owl_ontology(c: &mut Criterion) {
    ...
    for i in 0..10 {
        ...
        entity.add_property("batchId".to_string(), PropertyValue::String(format!("BATCH{:03}", i)));
        entity.add_property("sku".to_string(), PropertyValue::String(format!("SKU{:03}", i)));
...
pub fn bench_property_chain_inference(c: &mut Criterion) {
    ...
    for i in 0..10 {
        ...
        entity.add_property("producedBy".to_string(), PropertyValue::String("Dairy Farm A".to_string()));
        entity.add_property("locatedAt".to_string(), PropertyValue::String("Processing Plant B".to_string()));
        entity.add_property("inputTo".to_string(), PropertyValue::String(format!("Process {:03}", i)));
        entity.add_property("outputOf".to_string(), PropertyValue::String("Production XYZ".to_string()));
